            ...
            <div className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8 lg:py-20">
              <div className="prose prose-zinc max-w-none space-y-8 text-base leading-relaxed text-zinc-700">
                ...
                <div>
                  ...
                  <p className="mt-2">
                    Los precios de los servicios serán los indicados en el presupuesto acordado. Los precios están expresados en euros e IVA excluido, salvo indicación contraria. El pago deberá realizarse según las modalidades pactadas en el contrato específico.
                  </p>
                  <p className="mt-2">
                    AdimenAI se reserva el derecho de modificar los precios de sus servicios en cualquier momento, teniendo en cuenta que a los clientes con contrato en vigor se les aplicarán las condiciones económicas pactadas.
                  </p>
                </div>
