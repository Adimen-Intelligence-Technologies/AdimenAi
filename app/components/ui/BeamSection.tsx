...
export function BeamSection() {
  ...
  return (
    <section className="border-b border-zinc-200">
      <Wrapper>
        <div className="text-left sm:text-center px-4 py-12 sm:px-8 sm:py-16 lg:py-24">
          <div className="mb-3 inline-flex items-center justify-start sm:justify-center gap-2 text-lg font-semibold text-black tracking-tight">
...
const Icons = {
  ...
  whatsapp: () => (
    ...
    >
      ...
      />
      <path
        d="m54.532 138.45 2.235 1.324c9.387 5.571 20.15 8.518 31.126 8.523h.023c33.707 0 61.139-27.426 61.153-61.135.006-16.335-6.349-31.696-17.895-43.251A60.75 60.75 0 0 0 87.94 25.983c-33.733 0-61.166 27.423-61.178 61.13a60.98 60.98 0 0 0 9.349 32.535l1.455 2.313-6.179 22.558zm-40.811 23.544L24.16 123.88c-6.438-11.154-9.825-23.808-9.821-36.772.017-40.556 33.021-73.55 73.578-73.55 19.681.01 38.154 7.669 52.047 21.572s21.537 32.383 21.53 52.037c-.018 40.553-33.027 73.553-73.578 73.553h-.032c-12.313-.005-24.412-3.094-35.159-8.954zm0 0"
        fill="url(#b)"
      />
      <path
  ...
  messenger: () => (
    ...
    >
      <path
        d="M32 4C17.64 4 6 14.92 6 28c0 6.29 2.59 12.02 6.79 16.28L12 60l11.79-6.36C27.47 54.92 29.72 55.5 32 55.5c14.36 0 26-10.92 26-24.5S46.36 4 32 4Z"
        fill="#0084ff"
      />
      <path
        d="M17.5 20.5C17.5 18.29 19.29 16.5 21.5 16.5H42.5C44.71 16.5 46.5 18.29 46.5 20.5V32.5C46.5 34.71 44.71 36.5 42.5 36.5H32.5L24.5 44.5V36.5H21.5C19.29 36.5 17.5 34.71 17.5 32.5V20.5Z"
        fill="#fff"
      />
      <path
        d="M24.5 24.5H39.5C40.33 24.5 41 25.17 41 26V27.5C41 28.33 40.33 29 39.5 29H24.5C23.67 29 23 28.33 23 27.5V26C23 25.17 23.67 24.5 24.5 24.5Z"
        fill="#0084ff"
      />
      <path
        d="M24.5 31H37.5C38.33 31 39 31.67 39 32.5V33C39 33.83 38.33 34.5 37.5 34.5H24.5C23.67 34.5 23 33.83 23 33V32.5C23 31.67 23.67 31 24.5 31Z"
        fill="#0084ff"
      />
    </svg>
  ),
