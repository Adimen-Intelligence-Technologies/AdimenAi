...
export function ContactBlock() {
  return (
    <Wrapper>
      ...
      >
        <div className="mx-auto max-w-xl text-center px-2 sm:px-0 ">
          <div
            className={`mb-5 inline-flex items-center justify-center gap-2 text-base sm:text-lg font-semibold pt-2 `}
          ...
          <h2
            className={`text-3xl sm:text-4xl md:text-[40px] font-semibold`}
